...
public class HtPasswd {
	...
	public static void main(String[] args) throws Exception {
		HtPasswd password = new HtPasswd(HtPasswd.class.getResourceAsStream("/com/peterfranza/svnadmin/server/htpasswd/testpasswordfile"));
		System.out.println(password.authenticate("test", "password"));
		password.save(System.out);
	}
