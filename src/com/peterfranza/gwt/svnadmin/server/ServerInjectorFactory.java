	...
	
	{
		modules.add(new AbstractModule() {
			...
			protected void configure() {
				...
				bind(String.class).annotatedWith(Names.named("repositoryUsername")).toInstance("xxxx");
				bind(String.class).annotatedWith(Names.named("repositoryPassword")).toInstance("xxxx");
